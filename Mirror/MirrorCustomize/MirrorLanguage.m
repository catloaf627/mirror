                  ...
                  with1Placeholder:(NSString *)placeholder
{
    ...
    [mirrorDict setValue:@[@"The start timestamp of No.%@ task", @"第%@次任务的开始时间"] forKey:@"start_time_for_period"];
    [mirrorDict setValue:@[@"The end timestamp of No.%@ task", @"第%@次任务的开始时间"] forKey:@"end_time_for_period"];
